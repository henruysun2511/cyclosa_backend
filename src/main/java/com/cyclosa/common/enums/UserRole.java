...
public enum UserRole {
    ...
    DEPARTMENT_MANAGER("Department Manager / Line Manager",
            "Trưởng phòng ban trực tiếp, duyệt yêu cầu và đánh giá nhân viên trong phòng"),
    ...
    UNION_REPRESENTATIVE("Union Representative",
            "Đại diện công đoàn, giám sát các sự vụ khen thưởng, kỷ luật, khiếu nại"),
